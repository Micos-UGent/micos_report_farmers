...
subtitle: "Data for `r params$Farmer`"
output: pdf_document
params:
   Farmer: MC24_008
---
...
Binnen het MiCos project werden in 2023 240 velden in België, Nederland en Luxemburg stalen genomen voor microplastic analyse. 
...
file.exists(path_nutrients, path_farmers)
```
...
merged_df <- df_nutrients %>%
  left_join(df_farmers, by = "FieldID")
```
